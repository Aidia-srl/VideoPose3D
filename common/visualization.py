...
#     # Modify the `update_video` function to include joint markers
#     def update_video(i):
#         nonlocal initialized, image, lines, points, joint_markers
...
#         # Update 3D poses and joint markers
#         if not initialized:
#             for n, ax in enumerate(ax_3d):
#                 pos = poses[n][i]
#                 for j, j_parent in enumerate(parents):
...
#                     # Add lines for skeleton connections
#                     col = "red" if j in skeleton.joints_right() else "black"
#                     lines_3d[n].append(
#                         ax.plot(
#                             [pos[j, 0], pos[j_parent, 0]],
...
#                         )
#                     )
#                 # Add joint markers (balls) at each joint
...
#                 joint_markers[n]._offsets3d = (pos[:, 0], pos[:, 1], pos[:, 2])
